...
class AppTextStyles {
  static final TextStyle title = GoogleFonts.robotoSlab(
  ...
  static final TextStyle welcome = GoogleFonts.roboto(
    color: Colors.blue,
    fontSize: 30,
    fontWeight: FontWeight.bold,
  );
  ...
  static final TextStyle userHome = GoogleFonts.lato(
    color: Colors.white,
    fontWeight: FontWeight.bold,
    fontSize: 20,
  );
  static final TextStyle notification = GoogleFonts.lato(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: Colors.grey);
  ...
  static final TextStyle bottom = GoogleFonts.notoSans(
    color: AppColors.white,
    fontSize: 14,
    fontWeight: FontWeight.normal,
  );
