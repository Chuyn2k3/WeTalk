...
abstract class StudyRepository {
  Future<TopicModel> getListTopic();
...
class StudyRepositoryImp implements StudyRepository {
  @override
  Future<TopicModel> getListTopic() async {
    final dio = await DioBase.dioGetStudyFunction();
    try {
      final response = await dio.get(ApiConstants.allTopicUrl,
          options: Options(
            method: 'get',
            headers: {
